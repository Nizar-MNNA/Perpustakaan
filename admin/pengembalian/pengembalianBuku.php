...
$dataPeminjam = queryReadData("SELECT pengembalian.id, pengembalian.id_buku, buku.judul, buku.kategori, pengembalian.nrp, member.nama, member.kelas, member.jurusan, admin.nama_admin, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
INNER JOIN buku ON pengembalian.id = buku.id
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php foreach ($dataPeminjam as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="action">
                                        <a href="deletePengembalian.php?id=<?= $item["id"]; ?>"
