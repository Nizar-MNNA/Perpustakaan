...
$dataDenda = queryReadData("SELECT pengembalian.id, pengembalian.id_peminjaman, pengembalian.id_buku, buku.judul, pengembalian.nrp, member.nama, admin.nama_admin, pengembalian.buku_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
INNER JOIN buku ON pengembalian.id_buku = buku.id
INNER JOIN member ON pengembalian.nrp = member.nrp
INNER JOIN admin ON pengembalian.id_admin = admin.id
WHERE pengembalian.nrp = $nrpSiswa AND pengembalian.denda > 0");
?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success"
                                            href="formBayarDenda.php?id=<?= $item["id"]; ?>">Bayar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                </table>
